...
@section('page-title', 'Edit Formulir')
...
@section('content')
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-500 text-lg font-light flex items-center gap-2">
                    ...
                    Perbarui informasi formulir template
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 fade-in">
            ...
            <form action="{{ route('formulir-templates.update', $formulirTemplate) }}" method="POST"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_formulir" id="nama_formulir"
                            value="{{ old('nama_formulir', $formulirTemplate->nama_formulir) }}" required
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            ...
                            placeholder="Tambahkan deskripsi atau instruksi pengisian formulir...">{{ old('deskripsi', $formulirTemplate->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <div class="flex-1">
                                <p class="font-medium text-gray-900">{{ $formulirTemplate->nama_formulir }}</p>
                                <p class="text-sm text-gray-500">
                                    Diupload: {{ $formulirTemplate->created_at->format('d M Y, H:i') }}
                                </p>
                            </div>
                            <a href="{{ route('formulir-templates.show', $formulirTemplate) }}"
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                ...
                                Kosongkan jika tidak ingin mengganti file. Format: PDF, DOC, atau DOCX. Maksimal 5MB.
                            </p>
                        </div>
                        @error('file')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="is_active" id="is_active" value="1"
                                {{ old('is_active', $formulirTemplate->is_active) ? 'checked' : '' }}
