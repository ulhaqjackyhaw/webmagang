...
@section('content')
            ...
            <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-t-2xl px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 class="text-lg font-bold text-white">Terima Pengajuan</h3>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-auto transform transition-all">
            <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-t-2xl px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 class="text-lg font-bold text-white">Terima Semua Pengajuan</h3>
                    </div>
            ...
            <div class="p-6">
                <div class="flex flex-col items-center text-center mb-6">
                    ...
                    <h4 class="text-lg font-bold text-gray-800 mb-2">Konfirmasi Terima Massal</h4>
                    <p class="text-gray-600 text-sm">
                        <span id="bulkApproveCount" class="font-bold text-emerald-600">0</span> pengajuan akan diterima
                        dan diteruskan ke Deputy.
                    </p>
                </div>
                ...
                <form id="bulkApproveForm" method="POST" action="{{ route('approvals.divhead.bulkApprove') }}">
                    @csrf
    ...
    <div id="bulkRejectModal"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-auto transform transition-all">
            ...
            <form id="bulkRejectForm" method="POST" action="{{ route('approvals.divhead.bulkReject') }}"
                class="p-6">
                @csrf
