...
<body
    class="min-h-screen flex items-center justify-center py-12 antialiased selection:bg-accent-cyan selection:text-slate-950">
    ...
    <div class="container mx-auto px-6 max-w-4xl">
        ...
        <div class="glass rounded-3xl overflow-hidden shadow-2xl" data-aos="zoom-in" data-aos-duration="900">
            ...
            <div class="gradient-header pt-16 pb-10 px-8 text-center">
                <div
                    class="animate-success-pop bg-slate-900 rounded-full w-32 h-32 flex items-center justify-center mx-auto mb-8 glow-cyan">
                    <i class="fas fa-check text-6xl text-accent-cyan"></i>
                </div>
                <h1 class="text-5xl md:text-6xl font-extrabold text-white mb-4 tracking-tight animate-fade-up">
            ...
            <div class="p-10 md:p-12">
                ...
                <div class="text-center mb-10" data-aos="fade-up" data-aos-delay="200">
                    <p class="text-xl md:text-2xl text-slate-200 leading-relaxed">
                        Terima kasih telah mendaftar program magang <strong
                            class="text-accent-cyan">URSHIPORTS</strong>.<br>
                ...
                <div class="glass rounded-2xl p-10 mb-10" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start gap-6">
                            <div
                                class="rounded-full w-14 h-14 flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-accent-cyan to-cyanDark text-slate-950 font-bold text-xl shadow-lg">
                                1
                            </div>
                            <div class="flex-1">
                                <h4 class="text-xl font-bold text-white mb-2">Review Berkas</h4>
                                <p class="text-slate-300">Tim HC kami akan mereview semua dokumen dan data yang Anda
                                    kirimkan.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-slate-300">Anda akan dihubungi melalui WhatsApp dalam <strong
                                        class="text-accent-cyan">3-5 hari kerja</strong>.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-slate-300">Informasi lengkap mengenai hasil seleksi dan jadwal magang
                                    akan diberikan.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                <h4 class="text-xl font-bold text-white mb-2">Ada Pertanyaan?</h4>
                                <p class="text-slate-300">Apabila ada pertanyaan dapat menghubungi PIC berikut:</p>
                                <div class="mt-3 space-y-2">
                                    <a href="https://wa.me/6287876695169"
                                        class="flex items-center gap-2 text-accent-cyan hover:text-cyan-300 transition">
                                        <i class="fab fa-whatsapp"></i>
                                        <span>087876695169 <span class="text-slate-400 text-sm">(WhatsApp
                                                only)</span></span>
                                    </a>
                                    <a href="mailto:yudha.roland@injourneyairports.id"
                                        class="flex items-center gap-2 text-accent-cyan hover:text-cyan-300 transition">
                                        <i class="fas fa-envelope"></i>
                                        <span>yudha.roland@injourneyairports.id</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Important Notice -->
                <div class="bg-yellow-900/30 border border-yellow-600/50 rounded-2xl p-8 mb-10 flex items-start gap-6"
            ...
            <div class="bg-slate-900/60 px-10 py-8 text-center border-t border-slate-700">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-8 text-lg">
                    <a href="mailto:yudha.roland@injourneyairports.id"
                        class="flex items-center gap-3 text-accent-cyan hover:text-cyan-300 transition">
                        <i class="fas fa-envelope"></i>
                        yudha.roland@injourneyairports.id
                    </a>
                    <a href="https://wa.me/6287876695169"
                        class="flex items-center gap-3 text-accent-cyan hover:text-cyan-300 transition">
                        <i class="fab fa-whatsapp"></i>
