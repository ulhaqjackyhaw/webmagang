...
@section('content')
    <div class="fixed inset-0 w-full h-full bg-cover bg-center bg-no-repeat"
        ...
        <div class="min-h-screen flex items-center justify-center relative z-10 px-4">
            <div
                class="relative bg-white bg-opacity-95 backdrop-blur-sm p-10 rounded-3xl shadow-2xl w-full max-w-md transform hover:scale-105 transition-transform duration-300">
                <!-- Logo/Icon -->
